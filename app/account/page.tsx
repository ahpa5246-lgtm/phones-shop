  ...
  return (
    <main className="shell account-page">
      <section className="account-hero">
        ...
        <p className="section-sub">Manage your personal details, saved phones and most recent orders.</p>
      </section>
      ...
      {session.role === 'ADMIN' && <a className="pill primary" style={{marginTop:20}} href="/admin">Open admin dashboard</a>}
    </main>
  );
}
